...
/**
 * Created by bagga on 2017-07-17.
 */

public class HttpRequestGenerator {
    private static final HttpRequestGenerator ourInstance = new HttpRequestGenerator();
    private static final String TAG = "HttpRequestGenerator";

    public static HttpRequestGenerator getInstance() {
        return ourInstance;
    }
    ...
    public void callCloudVision(final Bitmap bitmap, final HttpRequestHandler httpRequestHandler, final Context context) throws IOException {
        ...
        new AsyncTask<Object, Void, Object>() {
            ...
            protected void onPostExecute(Object result) {
                httpRequestHandler.onPostExecute(result);
            }
        }.execute();
    }
